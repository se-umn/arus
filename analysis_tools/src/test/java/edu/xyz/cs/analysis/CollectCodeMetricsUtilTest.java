...
public class CollectCodeMetricsUtilTest{
    ...
    public void testParseReportValidFile() throws IOException, InterruptedException {
        ComplexityMetric result = CollectCodeMetricsUtil.runComplexityTool("src/test/java/edu/xyz/cs/analysis/testSource/");
    ...
    public void testParseReportFileNotFound() throws IOException, InterruptedException {
        CollectCodeMetricsUtil.runComplexityTool("src/test/java/edu/xyz/cs/analysis/testSources/"); // should throw IOException
    }
    ...
    public void testGetCSVFilesSuccess() throws IOException, InterruptedException {
        ...
        CollectCodeMetricsUtil.getcsvFiles("src/test/java/edu/xyz/cs/analysis/testSource/", "src/test/java/edu/xyz/cs/analysis/testSource/ck-0.7.1-SNAPSHOT-jar-with-dependencies.jar");
