...
import edu.umn.cs.analysis.model.CollectedRepoInfo;
import edu.umn.cs.analysis.model.Tag;
...
public class CollectReposInfo {
  ...
  public static void main(String args[]){
    if(args.length!=1){
      System.out.println("usage: ./gradlew clean -PmainClass=edu.umn.cs.analysis.CollectReposInfo run --args=\"config_file_name\"");
      System.exit(1);
    }
    try {
