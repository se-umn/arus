...
public class VaultUsernamePasswordCredentialIT {
    ...
    public void shouldRetrieveCorrectCredentialsFromVault() {
        ...
        //         VaultUsernamePasswordCredential up = mock(VaultUsernamePasswordCredentialImpl.class);
        ...
        //         p.setDefinition(new CpsFlowDefinition("" + "node {\n" + " withCredentials([[$class: 'UsernamePasswordMultiBinding', credentialsId: '" + credentialsId + "', usernameVariable: 'USERNAME', passwordVariable: 'PASSWORD']]) { " + "      " + getShellString() + " 'echo " + getVariable("USERNAME") + ":" + getVariable("PASSWORD") + " > script'\n" + "  }\n" + "}", true));
