...
//                VaultCertificateCredentials up = mock(VaultCertificateCredentialsImpl.class);
...
//                p.setDefinition(new CpsFlowDefinition("" + "node {\n" + " withCredentials([certificate(credentialsId: '" + credentialsId + "', passwordVariable: 'PASSWORD', keystoreVariable: 'KEYSTORE')]) { " + "      " + getShellString() + " 'echo " + getVariable("PASSWORD") + " > script'\n" + "      " + getShellString() + " '" + getCopyString() + " \"" + getVariable("KEYSTORE") + "\" keystore'\n" + "  }\n" + "}", true));
...
//            @Override
//            public void evaluate() throws Throwable {
//                VaultCertificateCredentialsImpl vup = new VaultCertificateCredentialsImpl(null, credentialsId, "Test Credentials");
...
//        });
    ...
    public void shouldFailIfMissingCredentials() {
        ...
        story.addStep(new Statement() {
            ...
            @Override
            public void evaluate() throws Throwable {
                VaultCertificateCredentialsImpl c = new VaultCertificateCredentialsImpl(null, credentialsId, "Test Credentials");
